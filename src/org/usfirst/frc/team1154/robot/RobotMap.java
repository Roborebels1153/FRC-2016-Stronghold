...
public class RobotMap {
	...
	public static int COLLECTOR_TOP_ROLLER = 4;
	public static int COLLECTOR_BOTTOM_ROLLER = 5;
	...
	public static int ART_ENCODER_A_CHANNEL = 4;
	public static int ART_ENCODER_B_CHANNEL = 5;
