 ...
 * Pass the DummyPIDOutput object to the PIDController class and read the output in your own code. This is useful for mixing the results 
 * of multiple PID controllers to one output.
